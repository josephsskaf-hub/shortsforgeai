...
// Animated typing demo component
function LiveDemoCard() {
  ...
  return (
    ...
    >
      ...
      {!outputVisible && (
        <div style={{ textAlign: 'center', padding: '10px 0', fontSize: '0.8rem', color: 'var(--muted)', opacity: 0.6 }}>
          Generating output…
        </div>
      )}
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', color: 'var(--text)', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 32px', height: 72, borderBottom: '1px solid var(--border)', background: 'rgba(8,8,15,.9)', backdropFilter: 'blur(24px)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <Link href="/dashboard" style={{ padding: '8px 20px', borderRadius: 10, fontSize: '0.82rem', fontWeight: 800, color: '#fff', textDecoration: 'none', background: 'linear-gradient(135deg, #6366f1, #7c3aed)', boxShadow: '0 4px 18px rgba(99,102,241,.4)' }}>Try Free</Link>
        </div>
      </nav>

      {/* Hero */}
      <section style={{ position: 'relative', zIndex: 10, textAlign: 'center', padding: '88px 24px 60px' }}>
        ...
        <h1 style={{ fontSize: 'clamp(2.2rem, 5.5vw, 3.8rem)', fontWeight: 900, lineHeight: 1.06, letterSpacing: '-0.03em', margin: '0 auto 20px', maxWidth: 820 }}>
          Type a topic →{' '}
          ...
          <br />scripts instantly
        </h1>

        <p style={{ fontSize: '1.05rem', color: 'var(--muted2)', maxWidth: 600, margin: '0 auto 36px', lineHeight: 1.65 }}>
          Generate hooks, titles, scripts, captions, hashtags, and video ideas in seconds — built for creators who want to post faster.
        </p>
        ...
        <p style={{ fontSize: '0.8rem', color: 'var(--muted)', letterSpacing: '0.01em' }}>
          No credit card required &nbsp;•&nbsp; 30-second generation &nbsp;•&nbsp; Creator-ready output
        </p>
      </section>
      ...
      <section style={{ position: 'relative', zIndex: 10, padding: '56px 24px', maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16 }}>
          {[
            { step: '01', icon: '🎯', title: 'Choose Your Niche', desc: 'Pick from 15 proven viral niches: History, Finance, True Crime, AI, Luxury, and many more.' },
      ...
      <section style={{ position: 'relative', zIndex: 10, padding: '56px 24px', maxWidth: 800, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20, alignItems: 'start' }}>
          ...
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 20, padding: '30px 28px 34px', boxShadow: '0 0 30px rgba(139,92,246,.08)' }}>
            ...
            {['1 free generation', '5 scripts per package', 'Viral hooks + titles', 'Hashtags included', 'Money Facts niche'].map((f) => (
          ...
          <div style={{ background: 'linear-gradient(135deg, rgba(99,102,241,.1), rgba(124,58,237,.06))', border: '2px solid rgba(99,102,241,.35)', borderRadius: 20, padding: '30px 28px 34px', position: 'relative', overflow: 'hidden', boxShadow: '0 0 60px rgba(99,102,241,.15)' }}>
            ...
            <Link href="/dashboard" style={{ display: 'block', marginTop: 22, padding: '14px 0', borderRadius: 12, textAlign: 'center', fontSize: '0.875rem', fontWeight: 900, color: '#fff', textDecoration: 'none', background: 'linear-gradient(135deg, #6366f1 0%, #7c3aed 55%, #a855f7 100%)', boxShadow: '0 4px 24px rgba(99,102,241,.45)' }}>
              ⭐ Start for $5
            </Link>
      ...
      <section style={{ position: 'relative', zIndex: 10, textAlign: 'center', padding: '56px 24px 88px' }}>
        <div style={{ maxWidth: 640, margin: '0 auto', background: 'linear-gradient(135deg, rgba(99,102,241,.1), rgba(124,58,237,.06))', border: '1px solid rgba(99,102,241,.25)', borderRadius: 24, padding: '56px 40px', boxShadow: '0 0 60px rgba(99,102,241,.12)' }}>
          ...
          <p style={{ fontSize: '0.9rem', color: 'var(--muted)', marginBottom: 30, lineHeight: 1.6 }}>
            Join 1,200+ creators generating viral content in seconds. Start free, no credit card required.
          </p>
          <Link href="/dashboard" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '16px 40px', borderRadius: 14, fontSize: '0.95rem', fontWeight: 900, color: '#fff', textDecoration: 'none', background: 'linear-gradient(135deg, #6366f1 0%, #7c3aed 55%, #a855f7 100%)', boxShadow: '0 6px 36px rgba(99,102,241,.5)' }}>
