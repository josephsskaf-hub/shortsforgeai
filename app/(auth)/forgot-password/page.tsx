        ...
        <div className="rounded-2xl p-8" style={{ background: 'var(--card)', border: '1px solid var(--border2)', boxShadow: '0 0 80px rgba(99,102,241,.08)' }}>
          {sent ? (
            <div className="text-center py-4">
              ...
              <Link href="/login" className="inline-flex items-center gap-2 text-sm font-semibold" style={{ color: 'var(--indigo-light)', textDecoration: 'none' }}>
                ← Back to Sign In
              </Link>
            </div>
          ) : (
            <>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg, #6366f1, #7c3aed)', boxShadow: '0 4px 22px rgba(99,102,241,.3)', opacity: loading ? 0.7 : 1, cursor: loading ? 'not-allowed' : 'pointer' }}
                >
