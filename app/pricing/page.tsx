      ...
      <section className="relative z-10 mx-auto max-w-5xl px-4 pt-12 pb-16 sm:px-6 sm:pt-16">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-[14px] text-[#86868b]">
            Not a re-clipper — Kineo generates the whole Short. <span className="text-[#f5f5f7] font-semibold">Creator is $24.90/mo with 1 Hollywood film included</span> where Revid &amp; StoryShort charge $39+. Or <span className="text-[#f5f5f7] font-semibold">50 videos for $9.90/mo</span>. Flat price, cancel anytime.
          </p>
