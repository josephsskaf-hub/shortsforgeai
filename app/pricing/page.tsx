...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'AI Generated uses the Seedance engine (great quality, 20 credits/video). Cinematic AI uses the premium Kling engine for top-tier cinematic motion (45 credits/video). Every AI engine is available on every paid plan — you just need the credits. Fast Mode (smart stock footage) is free.',
  },
  {
    q: 'How do credits work?',
    // KINEO-REBASE-2026-07-10 — halved numbers (credits are worth 2× more).
    a: 'An AI Generated video (Seedance) uses 20 credits. A Cinematic AI video (Kling) uses 45 credits. Starter includes 25 credits/month; Creator includes 120 credits/month; Studio includes 200 credits/month. Credits reset each month (no rollover).',
  },
]
  ...
  return [
    {
      ...
      tagline: '25 credits/month + free Fast videos with smart stock footage + AI voiceover.',
      features: [
        '⚡ 25 credits/month + free Fast videos',
    ...
    },
    {
      ...
      tagline: '120 credits/month — about 6 fully AI-generated videos (Seedance engine).',
      features: [
        '✨ 120 credits/mo → ~6 AI-generated videos (Seedance)',
    ...
    },
    {
      ...
      tagline: 'Cinematic quality — our best AI engine. 200 credits/month (vs Creator\'s 120) + the cinematic Kling engine at 1080p, priority render queue — about 4 premium videos, or up to 10 with Seedance.',
      features: [
        '🎬 ~4 cinematic AI videos/mo (Kling)',
        '67% more credits than Creator (200 vs 120/mo)',
