        ...
        <div className="wrap">
          ...
          <div className="price">
            ...
            <div className="plan pop">
              ...
              <ul><li><span className="ck">✓</span> <b>6 AI-generated</b> videos/mo (Seedance)</li><li><span className="ck">✓</span> 240 credits/month</li><li><span className="ck">✓</span> Every scene generated by AI</li><li><span className="ck">✓</span> Script + voiceover + captions</li></ul>
            ...
            <div className="plan">
              ...
              <ul><li><span className="ck">✓</span> <b>~4 Cinematic AI</b> videos/mo (Kling)</li><li><span className="ck">✓</span> 400 credits/mo (67% more)</li><li><span className="ck">✓</span> Highest quality + priority queue</li><li><span className="ck">✓</span> Everything in Creator</li></ul>
