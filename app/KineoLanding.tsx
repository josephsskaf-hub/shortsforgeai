        ...
        <div className="wrap">
          ...
          <div className="cmp"><table>
            ...
            <tbody>
              ...
              <tr><td>Starting price</td><td className="us">$9.90/mo</td><td>$15/mo</td><td>$29/mo</td><td>$19/mo</td></tr>
            </tbody>
          </table></div>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="price">
            {/* KINEO-SPRINT-OFFER-2026-07-14 — plan CTAs now go straight to the
                ...
                API route). This preserves the chosen tier+intro through
                login/signup: the checkout route bounces signed-out visitors to
                /login?redirect=<full checkout URL> and resumes automatically
                after auth (KINEO-CHECKOUT-RESUME). The old href="/signup"
                dropped the chosen plan on the floor. */}
            <div className="plan">
              ...
              <a className="btn btn-o" href="/api/stripe/checkout?tier=starter&intro=1">Start — $4.90 first month</a>
            </div>
            <div className="plan pop">
              ...
              <a className="btn btn-w" href="/api/stripe/checkout?tier=basic&intro=1">Go Creator — $9.90 first month</a>
            </div>
            <div className="plan">
              ...
              <a className="btn btn-o" href="/api/stripe/checkout?tier=pro">Continue with Studio</a>
            </div>
          </div>
