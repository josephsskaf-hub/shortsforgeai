        ...
        <div className="wrap">
          ...
          <div className="price">
            ...
            <div className="plan pop">
              ...
              <ul><li><span className="ck">✓</span> <b>1 Hollywood film</b>/mo included</li><li><span className="ck">✓</span> 150 credits/month (~7 AI videos)</li><li><span className="ck">✓</span> Every scene generated by AI</li><li><span className="ck">✓</span> Script + voiceover + captions</li></ul>
          ...
          <div className="snote">Not ready for a plan? <b>Start with 10 videos for $4.90</b> — one-time, no subscription, credits never expire.</div>
