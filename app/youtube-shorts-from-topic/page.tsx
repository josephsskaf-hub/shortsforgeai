...
const FAQ: { q: string; a: string }[] = [
  { q: 'Is there an AI that makes a YouTube Short from just a topic?', a: 'Yes. ShortsForgeAI turns a single topic into a finished faceless Short — it writes the script, records the AI voiceover, finds matching footage and adds captions, then renders a ready-to-post 9:16 video in about 60 seconds. You never film anything.' },
  { q: 'Can I make a YouTube Short from a script, narrated word-for-word?', a: 'Yes. Paste your own script and ShortsForgeAI narrates it verbatim, matches footage to each line and captions it — no editing or timeline required.' },
  { q: 'What is the cheapest AI to make YouTube Shorts from an idea?', a: 'ShortsForgeAI starts at $11.90/month with a 7-day money-back guarantee, and your first Short is free with no credit card. It is built only for faceless short-form, so it undercuts general-purpose AI video tools.' },
  { q: 'How is this different from OpusClip or Submagic?', a: 'OpusClip and Submagic re-clip or caption a long video you already filmed. ShortsForgeAI generates the entire video from a topic — ideal for faceless creators who start with nothing but an idea.' },
    ...
    <main style={{ minHeight: '100vh', background: '#0A0A0B', color: '#F1F5F9', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '64px 20px 88px' }}>
        ...
        <p style={{ fontSize: '1.08rem', color: '#C9C4DE', lineHeight: 1.6, margin: '16px 0 0' }}>
          Type one topic — or paste a script — and ShortsForgeAI generates the whole faceless Short for you: the hook and script, an AI voiceover, footage matched to every line, and captions. A ready-to-post 9:16 video in about 60 seconds. No camera, no editing, no timeline to learn.
        </p>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, margin: '26px 0 0' }}>
          <Link href="/generate" style={{ background: '#8B5CF6', color: '#fff', fontWeight: 800, padding: '14px 26px', borderRadius: 12, textDecoration: 'none' }}>Make your first Short free →</Link>
        ...
        <p style={p}>
          Most “AI Shorts” tools (OpusClip, Submagic, Klap) take a long video you already filmed and chop it into clips. That’s useless if you’re faceless and starting from just an idea. ShortsForgeAI works the other way around: it <strong style={{ color: '#F1F5F9' }}>creates the entire video from a topic</strong> — so you never need source footage, a camera, or an editing app.
        </p>

        <h2 style={h2}>Make Shorts from a topic, a script, or a whole niche</h2>
        <p style={p}>
          Give it a single idea and it writes a viral hook-driven script. Or paste your own script and it narrates it <strong style={{ color: '#F1F5F9' }}>word-for-word</strong>. It’s strongest in the niches that convert best on Shorts — money and billionaire habits, mystery and weird history, geography and extreme places, finance, and quick-learning facts — and it matches specific footage to each line instead of dropping in random stock.
        </p>
        ...
        <div style={{ marginTop: 44, textAlign: 'center', background: 'radial-gradient(circle at 50% 0%, rgba(139,92,246,0.18), #0c0c12 70%)', border: '1px solid rgba(139,92,246,0.25)', borderRadius: 18, padding: '34px 22px' }}>
          ...
          <p style={{ color: '#9D96B8', margin: '8px 0 18px' }}>Your first one is free — no credit card.</p>
