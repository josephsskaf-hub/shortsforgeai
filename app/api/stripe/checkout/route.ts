...
// Push #175 — simplified flat pricing, no discounts.
//   Basic:  $9.90 / month  (USD)  |  R$49.90 / month  (BRL)
//   Pro:   $19.90 / month  (USD)  |  R$99.90 / month  (BRL)
...
const TIER_PRICES: Record<Tier, Record<Currency, number>> = {
  basic: { usd: 990,  brl: 4990 },
  pro:   { usd: 1990, brl: 9990 },
}
