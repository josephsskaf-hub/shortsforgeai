        ...
        <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {MOTION_PRESETS.map((p) => (
                <button
                  ...
                  style={{
                    background: prompt === p.prompt ? 'rgba(16,185,129,0.15)' : 'rgba(255,255,255,0.04)',
                    border: prompt === p.prompt ? '1px solid rgba(52,211,153,0.5)' : '1px solid var(--border)',
                    color: prompt === p.prompt ? '#34D399' : 'var(--muted2)',
            ...
            <div className="flex gap-2 mt-3">
              {(['5', '10'] as const).map((d) => (
                <button
                  ...
                  style={{
                    background: duration === d ? 'rgba(16,185,129,0.15)' : 'rgba(255,255,255,0.04)',
                    border: duration === d ? '1px solid rgba(52,211,153,0.5)' : '1px solid var(--border)',
                    color: duration === d ? '#34D399' : 'var(--muted2)',
                    cursor: busy ? 'not-allowed' : 'pointer',
                  }}
                >
                  {d}s
          ...
          <section className="flex flex-col gap-2">
            ...
            <p className="text-[12px] text-center" style={{ color: 'var(--muted)' }}>
              10 credits per clip ·{' '}
              <span style={{ color: (credits ?? 0) >= 10 ? '#34D399' : '#f87171', fontWeight: 700 }}>
                you have {credits === null ? '—' : credits}
              </span>
              {!isLoggedIn && (
                <>
                  {' '}· <Link href="/login?redirect=/animate" style={{ color: '#34D399', fontWeight: 700 }}>sign in</Link>
                </>
              )}
            </p>
          </section>
