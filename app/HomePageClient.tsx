        ...
        <div className="relative">
          ...
          <div className="mt-9 grid gap-3 lg:grid-cols-[1.55fr_1fr]">
            ...
            <button
              ...
              className="group relative overflow-hidden rounded-2xl border border-[rgba(139,92,246,0.35)] p-6 text-left sm:p-7"
              style={{ background: 'radial-gradient(circle at 65% 20%, rgba(139,92,246,0.38), #140d22 55%, #0b0b10 82%)', minHeight: 230 }}
            >
