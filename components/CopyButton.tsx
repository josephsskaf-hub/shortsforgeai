  ...
  if (variant === 'small') {
    return (
      <button
        ...
        style={{
          background: copied ? 'rgba(16,185,129,.09)' : 'rgba(99,102,241,.07)',
          border: copied ? '1px solid rgba(16,185,129,.22)' : '1px solid rgba(99,102,241,.18)',
